...
import (
	common "exchange-system/order-service/proto/common"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
...
type Market struct {
	...
	MaxOrderSize   string                 `protobuf:"bytes,8,opt,name=max_order_size,json=maxOrderSize,proto3" json:"max_order_size,omitempty"`
	PriceIncrement string                 `protobuf:"bytes,9,opt,name=price_increment,json=priceIncrement,proto3" json:"price_increment,omitempty"`
	SizeIncrement  string                 `protobuf:"bytes,10,opt,name=size_increment,json=sizeIncrement,proto3" json:"size_increment,omitempty"`
...
func (x *ViewMarketsResponse) GetPageInfo() *common.PageInfo {
	if x != nil {
		return x.PageInfo
	}
	return nil
...
const file_spot_v1_spot_proto_rawDesc = "" +
	"\n" +
	"\x12spot/v1/spot.proto\x12\aspot.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x13common/common.proto\"\x92\x03\n" +
	"\x06Market\x12\x0e\n" +
	...
	"\x0fprice_increment\x18\t \x01(\tR\x0epriceIncrement\x12%\n" +
	"\x0esize_increment\x18\n" +
	" \x01(\tR\rsizeIncrement\x12#\n" +
	"\rallowed_roles\x18\v \x03(\tR\fallowedRoles\"3\n" +
	"\x12ViewMarketsRequest\x12\x1d\n" +
	"\n" +
	"user_roles\x18\x01 \x03(\tR\tuserRoles\"o\n" +
	...
	"\tGetMarket\x12\x19.spot.v1.GetMarketRequest\x1a\x1a.spot.v1.GetMarketResponseB-Z+exchange-system/order-service/proto/spot/v1b\x06proto3"
...
var file_spot_v1_spot_proto_depIdxs = []int32{
	...
	6, // 2: spot.v1.ViewMarketsResponse.page_info:type_name -> common.PageInfo
	0, // 3: spot.v1.GetMarketResponse.market:type_name -> spot.v1.Market
	1, // 4: spot.v1.SpotInstrumentService.ViewMarkets:input_type -> spot.v1.ViewMarketsRequest
	3, // 5: spot.v1.SpotInstrumentService.GetMarket:input_type -> spot.v1.GetMarketRequest
	2, // 6: spot.v1.SpotInstrumentService.ViewMarkets:output_type -> spot.v1.ViewMarketsResponse
	4, // 7: spot.v1.SpotInstrumentService.GetMarket:output_type -> spot.v1.GetMarketResponse
