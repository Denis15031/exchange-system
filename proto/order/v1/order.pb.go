...
type CreateOrderRequest struct {
	...
	UserRole       v1.UserRole            `protobuf:"varint,7,opt,name=user_role,json=userRole,proto3,enum=user.v1.UserRole" json:"user_role,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CreateOrderRequest) GetUserRole() v1.UserRole {
	if x != nil {
		return x.UserRole
	}
...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\border.v1\x1a\x13common/common.proto\x1a\x12user/v1/user.proto\"\xf2\x02\n" +
	"\x05Order\x12\x19\n" +
	...
	"\n" +
	"updated_at\x18\v \x01(\x03R\tupdatedAt\"\xfe\x01\n" +
	...
	"\tuser_role\x18\a \x01(\x0e2\x11.user.v1.UserRoleR\buserRole\"H\n" +
...
var file_order_v1_order_proto_goTypes = []any{
	...
	(v1.UserRole)(0),                  // 9: user.v1.UserRole
...
var file_order_v1_order_proto_depIdxs = []int32{
	...
	0,  // 2: order.v1.CreateOrderRequest.type:type_name -> order.v1.OrderType
	9,  // 3: order.v1.CreateOrderRequest.user_role:type_name -> user.v1.UserRole
	2,  // 4: order.v1.GetOrderStatusResponse.order:type_name -> order.v1.Order
	10, // 5: order.v1.ListOrdersRequest.pagination:type_name -> common.PaginationRequest
	2,  // 6: order.v1.ListOrdersResponse.orders:type_name -> order.v1.Order
	11, // 7: order.v1.ListOrdersResponse.pagination:type_name -> common.PaginationResponse
	3,  // 8: order.v1.OrderService.CreateOrder:input_type -> order.v1.CreateOrderRequest
	5,  // 9: order.v1.OrderService.GetOrderStatus:input_type -> order.v1.GetOrderStatusRequest
	...
	6,  // 12: order.v1.OrderService.GetOrderStatus:output_type -> order.v1.GetOrderStatusResponse
