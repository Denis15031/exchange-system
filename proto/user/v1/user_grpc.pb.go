...
type UserServiceClient interface {
	...
	UpdateRole(ctx context.Context, in *UpdateRoleRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) UpdateRole(ctx context.Context, in *UpdateRoleRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
type UserServiceServer interface {
	...
	UpdateRole(context.Context, *UpdateRoleRequest) (*User, error)
...
func (UnimplementedUserServiceServer) UpdateRole(context.Context, *UpdateRoleRequest) (*User, error) {
